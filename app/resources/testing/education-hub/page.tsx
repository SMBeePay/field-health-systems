  ...
  return (
    <>
      ...
      <nav className="flex mb-8 text-sm">
        ...
        <Link href="/resources/testing" className="hover:text-green-700" style={{ color: '#4CAF50' }}>Testing</Link>
        <span className="mx-2 text-gray-500">/</span>
      ...
      <article className="max-w-6xl">
        ...
        <header className="text-center mb-16">
          ...
          <p className="text-2xl font-semibold mb-8" style={{ color: '#4CAF50' }}>
            ...
            {roleCards.map((role, index) => (
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <p className="font-semibold text-sm" style={{ color: '#4CAF50' }}>{role.subtitle}</p>
                </div>
                ...
                <ul className="space-y-2">
                  {role.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start text-sm">
                      <span className="mr-2 font-bold" style={{ color: '#4CAF50' }}>✓</span>
              ...
              <div key={index} className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium" style={{ color: '#4CAF50' }}>{category.title}</p>
                  </div>
                </div>
                ...
                <ul className="space-y-2 mb-6">
                  {category.items.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-start text-sm">
                      <span className="mr-2" style={{ color: '#4CAF50' }}>•</span>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {gettingStartedSteps.map((step, index) => (
                ...
                >
                  <div
                    className="w-12 h-12 text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold"
        ...
        {/* Stay Updated */}
        <section className="mb-16">
          <div className="rounded-lg p-8 text-white text-center" style={{ background: 'linear-gradient(to right, #4CAF50, #2563eb)' }}>
        ...
        <section className="text-center">
          ...
          <div className="space-x-4">
            <Link
              href="/contact"
              className="inline-block text-white font-semibold px-8 py-4 rounded-lg transition-colors text-lg"
              style={{ background: '#4CAF50' }}
            >
