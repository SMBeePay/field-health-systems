...
export const metadata: Metadata = {
  title: 'Artificial Turf Testing in Austin, TX | Field Health Systems',
  description: 'Independent GMAX, shear factor, and infill depth testing for school districts across the Austin metro and Central Texas.',
  keywords: 'artificial turf testing, Austin, gmax testing, shear factor testing, infill depth testing, sports field testing, school district turf testing',
  openGraph: {
    title: 'Artificial Turf Testing in Austin, TX | Field Health Systems',
    description: 'Independent GMAX, shear factor, and infill depth testing for school districts across the Austin metro and Central Texas.',
    url: 'https://www.fieldhealthsystems.com/service-areas/austin',
    type: 'website',
    images: [{
      url: 'https://www.fieldhealthsystems.com/og-image.jpg',
      width: 1200,
      height: 630,
      alt: 'Artificial Turf Testing in Austin, TX | Field Health Systems'
    }]
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.fieldhealthsystems.com/service-areas/austin'
  }
}
