...
export const metadata: Metadata = {
  title: 'Artificial Turf Testing in Beaumont & Southeast Texas | Field Health Systems',
  description: 'Independent artificial turf testing for Beaumont-area school districts in the Golden Triangle region of Southeast Texas.',
  keywords: 'artificial turf testing, Beaumont & Southeast Texas, gmax testing, shear factor testing, infill depth testing, sports field testing, school district turf testing',
  openGraph: {
    title: 'Artificial Turf Testing in Beaumont & Southeast Texas | Field Health Systems',
    description: 'Independent artificial turf testing for Beaumont-area school districts in the Golden Triangle region of Southeast Texas.',
    url: 'https://www.fieldhealthsystems.com/service-areas/beaumont-southeast-texas',
    type: 'website',
    images: [{
      url: 'https://www.fieldhealthsystems.com/og-image.jpg',
      width: 1200,
      height: 630,
      alt: 'Artificial Turf Testing in Beaumont & Southeast Texas | Field Health Systems'
    }]
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.fieldhealthsystems.com/service-areas/beaumont-southeast-texas'
  }
}
