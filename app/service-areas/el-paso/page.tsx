...
export const metadata: Metadata = {
  title: 'Artificial Turf Testing in El Paso, TX | Field Health Systems',
  description: 'Independent artificial turf testing for El Paso-area school districts, built for high desert heat, intense UV, and low humidity.',
  keywords: 'artificial turf testing, El Paso, gmax testing, shear factor testing, infill depth testing, sports field testing, school district turf testing',
  openGraph: {
    title: 'Artificial Turf Testing in El Paso, TX | Field Health Systems',
    description: 'Independent artificial turf testing for El Paso-area school districts, built for high desert heat, intense UV, and low humidity.',
    url: 'https://www.fieldhealthsystems.com/service-areas/el-paso',
    type: 'website',
    images: [{
      url: 'https://www.fieldhealthsystems.com/og-image.jpg',
      width: 1200,
      height: 630,
      alt: 'Artificial Turf Testing in El Paso, TX | Field Health Systems'
    }]
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.fieldhealthsystems.com/service-areas/el-paso'
  }
}
