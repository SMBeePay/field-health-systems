...
export const metadata: Metadata = {
  title: 'Artificial Turf Testing in the Rio Grande Valley | Field Health Systems',
  description: 'Independent artificial turf testing for Rio Grande Valley school districts, built for South Texas extreme heat and rapid growth.',
  keywords: 'artificial turf testing, the Rio Grande Valley, gmax testing, shear factor testing, infill depth testing, sports field testing, school district turf testing',
  openGraph: {
    title: 'Artificial Turf Testing in the Rio Grande Valley | Field Health Systems',
    description: 'Independent artificial turf testing for Rio Grande Valley school districts, built for South Texas extreme heat and rapid growth.',
    url: 'https://www.fieldhealthsystems.com/service-areas/rio-grande-valley',
    type: 'website',
    images: [{
      url: 'https://www.fieldhealthsystems.com/og-image.jpg',
      width: 1200,
      height: 630,
      alt: 'Artificial Turf Testing in the Rio Grande Valley | Field Health Systems'
    }]
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.fieldhealthsystems.com/service-areas/rio-grande-valley'
  }
}
